window.hjSiteSettings = window.hjSiteSettings || {
    "site_id": 2479149,
    "rec_value": 3.999999997894577e-9,
    ...
    "features": ["ask.popover_redesign", "client_script.compression.pc", "error_reporting", "feedback.embeddable_widget", "feedback.widgetV2", "feedback.widget_telemetry", "settings.billing_v2", "survey.embeddable_widget", "survey.image_question", "survey.screenshots", "survey.type_button"],
...
!function() {
    ...
    ,
    window.hj.metrics = p;
    var _, S, T, E, R, M, C, O, A, x, I, N, k, U, P, B, D = hj.metrics.start(), F = !(!window.CS_CONF || null === (y = window.CS_CONF.voc) || void 0 === y || !y.enabled), L = !(window.CS_CONF || !(null !== (j = window.hjSiteSettings.features) && void 0 !== j && j.includes("cs_lite") || window._hjSettings.csid));
    if (window.hjLazyModules = window.hjLazyModules || {
        SURVEY_V2: {
            js: "survey-v2.a4d4a69b3c434296ce21.js"
        },
        SURVEY_BOOTSTRAPPER: {
            js: "survey-bootstrapper.5280a8379cf419902f72.js"
        },
        SURVEY_ISOLATED: {
            js: "survey-isolated.4552302bd7eac650926f.js"
        },
        HEATMAP_RETAKER: {
            js: "heatmap-retaker.f79c0c7bb13d8a14bddc.js"
        },
        SURVEY_INVITATION: {
            js: "survey-invitation.9a91b66dc1e33840228c.js"
        },
        NOTIFICATION: {
        ...
        USER_TEST: {
            js: "user-test.5bcd2402794f4eb0f7ce.js"
        }
    },
    F)
        ...
        var z = (C = (_ = window.hjSiteSettings).suppress_all || _.suppress_text || (null === (S = _.suppress_all_on_specific_pages) || void 0 === S ? void 0 : S.length),
        O = function(e) {
            var t, n, r, i, a, o = {
        ...
        I = O.replayRecordingMaskedUrlRegexRules,
        {
            CS_CONF_BASE: {
                ...
                smbConfig: {
                    siteId: _.site_id,
                    useCSTC: !0,
                    csLiteDomain: null !== (T = _hjSettings) && void 0 !== T && T.environment && "live" !== _hjSettings.environment ? "insights-integration.live.eks.hotjar.com" : "insights.hotjar.com"
                },
                hostnames: [window.location.hostname],
                voc: null !== (E = _.feedback_widgets) && void 0 !== E && E.length || null !== (R = _.polls) && void 0 !== R && R.length ? {
                    enabled: 1,
                    siteId: _.site_id
                } : {
                    enabled: 0
                ...
                implementations: (N = _,
                k = m,
                U = "manual" === (B = N.state_change_listen_mode) ? [] : [{
                    template: {
                    ...
                    triggers: [{
                        name: "HistoryChange",
                        args: {
                            listeners: "popstate, pushState, replaceState" + ("automatic_with_fragments" === B ? ", hashchange" : ""),
                            useDebounce: "no",
                            window: 400
                        }
                    }]
                }],
                U && !Array.isArray(U) && "number" == typeof U.length ? v(U, U.length) : k(U, P)),
                anonymisationMethod: A,
                replayRecordingMaskedUrlRegex: x,
                replayRecordingMaskedUrlRegexRules: I
            },
            PII_SELECTORS: _.suppress_all || (null === (M = _.suppress_all_on_specific_pages) || void 0 === M ? void 0 : M.length) ? ["img, video, source"] : null
        })
          , H = z.CS_CONF_BASE
          , V = z.PII_SELECTORS;
        window.CS_CONF_BASE = H,
        window._uxa = window._uxa || [],
        V && window._uxa.push(["setPIISelectors", {
            PIISelectors: V
        }]);
        var q = window._hjSettings.environment
          , Y = "t.contentsquare.net";
        q && "live" !== q && (window._hjSettings.csid && (window.CS_CONF_BASE.projectId = window._hjSettings.csid),
        ...
        ,
        window.hjBootstrap("https://script.hotjar.com/", "modules.02161fb4f8ebb73fb3f8.js", "2479149"),

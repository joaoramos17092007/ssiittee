function UET(o) {
    ...
    this.checkuetHostdocumentload = function() {
        ...
        if (n.documentLoaded || !document.body || document.readyState && document.readyState !== "interactive" && document.readyState !== "complete" && document.readyState !== "loaded" || n.deferLoad || (n.documentLoaded = !0),
        !n.documentLoaded) {
            setTimeout(function() {
        ...
        if (n.evqCDispatch === !1)
            for (n.dispatchq(!0),
            n.evqCDispatch = !0,
            t = 0; t < n.eventPushQueue.length; t++)
                n.eventPushQueue[t]instanceof Array && n.processEarly[n.eventPushQueue[t][0]] && n._push(n.eventPushQueue[t]);
    ...
    this.tcfCallback = function(n, t) {
        if (t) {
            ...
            try {
                if (this.uetConfig.tcf.gdprApplies = n.gdprApplies,
                n.gdprApplies === !0) {
                    var i = function(t) {
            ...
            this.uetConfig.tcf.hasLoaded || (this.uetConfig.tcf.hasLoaded = !0,
            clearTimeout(this.uetConfig.tcf.timeoutId),
            this.uetConfig.tcf.timeoutId = null,
            this.uetConfig.consent.enforced === !0 && (this.uetConfig.consent.enabled = !1,
    ...
    this.sanitizeTagId = function(o) {
        ...
        o.ti && (o.ti = o.ti.toString(),
        o.ti = o.ti.replace(/[^\w-]/g, ""))
    }
    ;
    ...
    this.loadConfig = function() {
        ...
        n.src = "https://clarity.microsoft.com/js/" + encodeURIComponent(o.clarityProjectId),
        ...
        for (f in o)
            v.hasOwnProperty(f) && (this.beaconParams[f] = v[f] === 1 ? encodeURIComponent(o[f]) : o[f]);
        ...
        y = 0; y < 5; y++)
            ...
            !window[t])
                break;
        this.stringExists(o.ti) && (k = ["56004448", "5798164", "20132024", "4000835", "4074038"],
        p = window.navigator.userLanguage || window.navigator.language,
        this.stringExists(p) && p.indexOf("de") === 0 && k.indexOf(o.ti) !== -1 && (this.uetConfig.deBlock = !0,
        ...
        w = e + "//" + this.domain + "/p/action/" + encodeURIComponent(o.ti) + ".js",
        this.stringExists(this.uetConfig.batDebug) && (w += "?bat_debug=" + this.uetConfig.batDebug),
        n.src = w,
        n.type = "text/javascript",
        n.async = 1,
        ...
        h.length > 0 && !!window.Promise && !!window.Promise.allSettled && (this.deferLoad = !0,
        ...
        this.stringExists(this.uetConfig.batDebug) && window.opener && this.stringExists(o.ti) && (b = "https://ui.ads.microsoft.com",
        document.referrer && window.URL && (c = new URL(document.referrer),
        c.protocol === "https:" && /\.microsoft\.com$/.test(c.hostname) && (b = c.origin)),
        ...
        if (n[1]instanceof Array)
            if (n[0] === "event") {
                ...
                t === null || typeof t != "object")
                    return;
                if (t.hasOwnProperty("source") && this.stringExists(t.source) && t.source.indexOf("gtm_") === 0 && (o = !0,
                t.source === "gtm_update" && t.hasOwnProperty("ad_storage") && (this.fireSendBeacon("gtmConsent", {
                    gasc: t.ad_storage !== "denied" ? "G" : "D"
                }),
                this.uetConfig.cusig.blob.ec === !0 && (o = !1)),
                o))
                    return;
    ...
    this.fireBeaconImg = function(n) {
        ...
        if (this.uetConfig.msDns !== !0)
            return t = this.createInvisibleElement(this.invisibleDiv, "img"),
            t.width = 0,
            t.height = 0,
    ...
    this.evt = function(n, t, i, r) {
        ...
        typeof i == "object") {
            ...
            this.uetConfig.msDns !== !0 && (this.beaconParams.bo = (this.beaconParams.bo || 0) + 1,
            this.fireBeacon(i),
            i.abf = !0);
    ...
    this.enforceConsent = function() {
        ...
        this.shouldEnforce(n) ? (this.uetConfig.consent.enabled = !0,
        this.uetConfig.consent.adStorageAllowed = !1,
        this.uetConfig.consent.enforced = !0,
        delete this.beaconParams.sid,
        delete this.beaconParams.vid,
        delete this.beaconParams.vids,
        delete this.beaconParams.msclkid,
        t !== !0 && this.fireConsentPing("enforced")) : n.hasCookie === !0 && this.uetConfig.consent.enforced === !0 && (this.uetConfig.consent.enabled = !1,
        this.uetConfig.consent.enforced = !1,
        t !== !1 && this.fireConsentPing("unenforced"))
    }
    ;
    this.addConsentParams = function(n) {
        if (this.uetConfig.consent.enabled === !0 && (n.asc = this.uetConfig.consent.adStorageAllowed ? "G" : "D"),
        this.uetConfig.tcf.enabled === !0) {
            var t = {
                st: this.uetConfig.tcf.hasLoaded === !0 ? "L" : "E"
            };
            this.uetConfig.tcf.gdprApplies === !0 && (t.gdpr = "Y",
            this.uetConfig.tcf.adStorageAllowed === !0 && (t.as = "G"),
            this.uetConfig.tcf.measurementAllowed === !0 && (t.ms = "G"),
            this.uetConfig.tcf.personalizationAllowed === !0 && (t.pz = "G"));
    ...
    this.setUserSignals = function(n) {
        typeof n == "object" && n !== null && (this.uetConfig.cusig.blob = n,
        this.enforceConsent());
        this.uetConfig.cusig.hasLoaded || (this.uetConfig.cusig.hasLoaded = !0,
        clearTimeout(this.uetConfig.cusig.timeoutId),
        this.uetConfig.cusig.timeoutId = null,
        this.uetLoaded !== !0 && this.checkuetHostdocumentload())
    }
    ;

...
!function() {
    ...
    var I, T = "5.29.0", u = ((P = I = I || {})[P.None = 0] = "None",
    P[P.Cookie = 1] = "Cookie",
    ...
    o.prototype.getFromAllStorages = function() {
        ...
        case I.None:
            var e = null
              , t = (this.useLocalStorage && (e = window.localStorage.getItem(this.cookieName)),
            this.getValue() || null);
            return {
                value: t || e,
                identifierExtractor: {
    ...
    o.prototype.setOnMainDomainWithExpiration = function(e, t) {
        for (var n = new Date, o = (n.setTime(n.getTime() + t),
        "expires=" + n.toUTCString()), i = null === document.location ? [] : document.location.hostname.split("."), r = null, a = 0; a < i.length; ++a) {
            var c = "domain=." + (r = i.slice(i.length - a - 1, i.length).join("."))
              , s = encodeURIComponent || escape
              , s = (document.cookie = this.cookieName + "=" + s(e) + ";" + o + ";" + c + ";path=/",
            this.getValue());
            if (s && s === e)
                break
        }
    ...
    var _, t, i = "OneTag", S = ["color: #fff;", "background: #ff4f00;", "display: inline-block;", "padding: 1px 4px;", "border-radius: 3px;"].join(" "), W = ((P = _ = _ || {})[P.Off = 0] = "Off",
    P[P.Error = 1] = "Error",
    ...
    r.setLogLevel = function(e) {
        r.level = e,
        this.debug("Log level set to " + _[e])
    }
    ,
    r.debug = function() {
    ...
    r.log = function(e, t, n) {
        t <= r.level && (t = 0 < (t = window.navigator.userAgent).indexOf("MSIE ") || 0 < t.indexOf("Trident/") ? ["[" + i + "]"] : ["%c" + i, S],
    ...
    a.onDocumentReady = function(n, o) {
        if ("complete" === document.readyState)
            ...
            document.onload = document.onreadystatechange = function(e) {
                ...
                t || document.readyState && "complete" !== document.readyState || (i instanceof Function && i(document, e),
                t = !0,
                o())
            }
            )
    ...
    a.getOneTagLocation = function() {
        try {
            ...
            return W.info("Cannot get OneTag location", e),
            t.Unknown
        }
    }
    ,
    ...
    s.prototype.onUserIdAvailable = function(o, i) {
        function r(e) {
            var t, n;
            c || (t = e * s.retryIntervalMs,
            void 0 !== (n = a.instance()) ? (c = !0,
            n.onUpdate(function(e) {
                e = e.getUserId();
                return a.logger("user ID available:", e),
                void 0 !== e && localStorage.setItem(s.localStorageKey, e),
                o(e)
            })) : i <= t ? (c = !0,
            a.logger("timeout waiting for instance after waiting (ms):", t),
            o(void 0)) : (a.exceptionHandler.setProtectedTimeout(function() {
                return r(e)
            }, s.retryIntervalMs),
            e++))
        }
    ...
    ,
    s.criteoPartnerId = 203,
    s.retryIntervalMs = 100,
    s.maxWaitForApiMs = 2e4,
    s.localStorageKey = "criteo-id5id-fast-track";
    var G = s;
    function s() {
        this.logger = function() {
            ...
            return W.debug.apply(W, function() {
                ...
                for (var o = Array(e), i = 0, t = 0; t < n; t++)
                    for (var r = arguments[t], a = 0, c = r.length; a < c; a++,
                    i++)
                        o[i] = r[a];
                return o
            }(["[ID5]"], e))
    ...
    l.prototype.pingWithTimeout = function(o, e, t, n) {
        ...
        return window.setTimeout(function() {
            ...
            r.executeCommand("ping", null, function(e, t) {
                ...
                !0 !== e.cmpLoaded && i(o, "GDPR ping returned cmpLoaded which is not true"),
                r.logger("GDPR ping returned cmpLoaded which is true")) : i(o, "Error sending ping to GDPR CMP")
            })
        }, t)
    }
    ,
    ...
    l.prototype.executeRetrieveConsent = function(e, t, n) {
        var o = this
          ...
          , r = window.setTimeout(function() {
            i = !0,
            o.logger("Timeout: Unable to resolve GDPR consent after " + o.timeout + "ms"),
            n(void 0)
        }, this.timeout)
          , a = !1 !== this.cmpAutoDetect ? this.pingWithTimeout(r, this.pingTimeout, this.pingDelay, function() {
            i = !0,
            o.logger("Timeout: Unable to ping GDPR API after " + o.pingTimeout + "ms"),
            n(void 0)
        }) : void 0;
        this.executeCommand(e, t, function(e, t) {
            clearTimeout(a),
            i || (clearTimeout(r),
            t ? (o.logger("GDPR consent retrieved"),
            o.processConsentData(e, n)) : (o.logger("Error retrieving GDPR consent data from CMP"),
            n(void 0)))
        })
    }
    ,
    ...
    l.prototype.executeCommand = function(e, t, n) {
        ...
        this.currentWindow.__cmp = function(e, t, n) {
            ...
            i.cmpCallbacks[e] = n,
            o.postMessage(t, "*")) : (i.logger("GDPR CMP not found in any frame"),
            n({
        ...
        this.currentWindow.addEventListener("message", function(e) {
            ...
            i.cmpCallbacks) && i.cmpCallbacks[e.callId] && (i.cmpCallbacks[e.callId](e.returnValue, e.success),
    ...
    p.prototype.pingWithTimeout = function(n, e, t, o) {
        ...
        return window.setTimeout(function() {
            ...
            r.executeCommand("ping", 2, function(e) {
                ...
                "error" === e.cmpStatus ? i(n, "Error status on ping to TCFv2 CMP") : !0 !== e.cmpLoaded ? i(n, "TCFv2 ping returned cmpLoaded = false") : r.logger("TCFv2 ping returned cmpLoaded = true")
            })
        }, t)
    }
    ,
    p.prototype.retrieveConsent = function(n) {
        var o, i, r = this, a = !1, c = window.setTimeout(function() {
            a = !0,
            i === d.UI_SHOWN ? (r.logger("Timeout: User hasn't confirm their consent settings after " + r.timeout + "ms"),
            n(o)) : (r.logger("Timeout: Unable to resolve TCFv2 consent after " + r.timeout + "ms"),
            n(void 0))
        }, this.timeout), s = !1 !== this.cmpAutoDetect ? this.pingWithTimeout(c, this.pingTimeout, this.pingDelay, function() {
            a = !0,
        ...
        this.executeCommand("addEventListener", 2, function(e, t) {
            clearTimeout(s),
            a || ((i = e.eventStatus) !== d.UI_SHOWN && clearTimeout(c),
            t ? (r.logger("TCFv2 consent retrieved in ms"),
            e || (r.logger("Unable to read GDPR consent data from CMP"),
            n(void 0)),
            o = r.processResponseData(e),
            (!1 === e.gdprApplies && void 0 === i || i === d.LOADED || i === d.USER_ACTION_COMPLETE) && n(o)) : (r.logger("Error retrieving TCFv2 consent data from CMP"),
            n(void 0)))
        })
    }
    ,
    ...
    p.prototype.executeCommand = function(e, t, n, o) {
        ...
        this.currentWindow.__tcfapi = function(e, t, n, o) {
            ...
            r.cmpCallbacks[e] = n,
            i.postMessage(t, "*")) : (r.logger("TCFv2 CMP not found in any frame"),
            n({
        ...
        this.currentWindow.addEventListener("message", function(e) {
            ...
            e.returnValue.eventStatus !== d.UI_SHOWN) && delete r.cmpCallbacks[e.callId]
        }, !1)),
    ...
    h.prototype.retrieveConsent = function(n) {
        var o = this
          ...
          , r = window.setTimeout(function() {
            i = !0,
            o.logger("Timeout: Unable to resolve CCPA consent after " + o.timeout + "ms"),
            n(void 0)
        }, this.timeout);
        this.executeCommand("getUSPData", 1, function(e, t) {
            i || (clearTimeout(r),
            t ? (o.logger("CCPA consent retrieved"),
            o.processResponseData(e, n)) : (o.logger("Error retrieving CCPA consent data from CMP"),
            n(void 0)))
        })
    }
    ,
    ...
    h.prototype.executeCommand = function(e, t, n) {
        ...
        this.currentWindow.__uspapi = function(e, t, n) {
            ...
            o.postMessage(t, "*")) : (i.logger("CCPA CMP not found in any frame"),
            n({
        ...
        this.currentWindow.addEventListener("message", function(e) {
            ...
            i.uspapiCallbacks) && i.uspapiCallbacks[e.callId] && (i.uspapiCallbacks[e.callId](e.returnValue, e.success),
    ...
    f.prototype.retrieveConsent = function(t) {
        var n, e = this.tcfCompatibleConsentProvider.readyToRetrieve(), o = this.ccpaConsentProvider.readyToRetrieve(), i = {};
        e || o ? (n = e && o ? 2 : 1,
    ...
    function f(e, t, n, o, i) {
        ...
        this.tcfCompatibleConsentProvider = new F(new E(e,t,W.info),new x(e,t,W.info),W.info),
    ...
    function B(e) {
        ...
        if (e instanceof Function)
            return (t = e())instanceof Function ? t : B(t);
        if (e instanceof Array)
    ...
    function J(e, t) {
        for (var n = 0, o = e; n < o.length; n++) {
            var i = o[n];
            if (i.event === t.event && j(t.account, i.account) && i.hash_method === t.hash_method)
                return void (void 0 !== t.email && (i.email = function(e, t) {
                    var n = [];
                    if (void 0 === e)
        ...
        if (e.callbacks) {
            for (var n = 0, o = "string" == typeof e.callbacks ? [e.callbacks] : e.callbacks; n < o.length; n++) {
                var i = o[n]
                  ...
                  , i = (r.setAttribute("style", "display:none;"),
    ...
    g.prototype.getParameterValueByName = function(e, t) {
        if (e && 1 < e.length) {
            var n, t = "&" + t + "=", o = (e = "?" === e[0] ? "&" + e.substr(1) : e).indexOf(t);
            if (-1 !== o)
                return n = e.indexOf("&", o + t.length),
    ...
    y.prototype.createIframe = function(e, t, n, o, i) {
        var r = document.createElement("iframe")
          ...
          , e = ("#gum-debug-mode" === window.location.hash ? o += "?debug=1&topUrl=" + a : o += "?topUrl=" + a,
        c && (o += "&origin=" + c),
        i.gdprConsent)
          , a = (e && (void 0 !== e.gdprApplies && (o += "&gdpr=" + (e.gdprApplies ? 1 : 0)),
        void 0 !== e.consentData) && (o += "&gdpr_consent=" + e.consentData),
        i.ccpaConsent);
        return a && void 0 !== a.uspString && (o += "&us_privacy=" + a.uspString),
        o += "#" + JSON.stringify(t),
        r.src = o,
    ...
    function y() {
        ...
        this.gumSyncFrameEndPoint = window.CriteoSyncFrameUrlOverride || this.gumSyncFrameOrigin + "/syncframe",
    ...
    function ne(e, t, n, o, i) {
        var r, a, c, s;
        return document && window.location.hash && (a = U.exec(window.location.hash)) && 4 === a.length && (r = "enable" === a[1],
        a = Number(a[3]),
        new u("criteoTagDebugMode",r ? 864e5 : 0).setValueWithNoDomain(r && a && !isNaN(a) ? String(a) : "0"),
        window.location.href = window.location.href.substr(0, window.location.href.indexOf("#"))),
        document && "function" == typeof Array.prototype.indexOf && -1 !== document.cookie.indexOf("criteoTagDebugMode=") ? (c = i,
        s = {
            ...
            push: function() {
                for (var e = [], t = 0; t < arguments.length; t++)
                    e[t] = arguments[t];
                0 < e.length && this.stagedPushes.push(e),
                c.stopRecordingInit()
            },
        ...
        r = s,
        document && (a = "ld-tag-debug." + T + ".js",
        (i = document.createElement("script")).setAttribute("type", "text/javascript"),
        i.setAttribute("src", document.location.protocol + "//static.criteo.net/js/ld/" + a),
        (a = document.getElementsByTagName("script")[0]).parentNode.insertBefore(i, a)),
        r) : e
    }
    function oe(t, n) {
        function e(e) {
    ...
    k.prototype.registerTrigger = function(e) {
        var t;
        this.isFeatureAllowed("attribution-reporting") && ((t = document.createElement("img")).setAttribute("style", "display:none;"),
        t.setAttribute("width", "1"),
        t.setAttribute("height", "1"),
        t.setAttribute("attributionsrc", k.ATTRIBUTION_TRIGGER_URL_PREFIX + "?" + e),
    ...
    function se() {
        ...
        var e, n, t, o, i, r, a, c, s, F = new D, h = new ee, y = (h.startRecordingInit(),
        {
            app: {
                accounts: [],
                actions: [],
        ...
        v("addClientSideSupportForId5") && ((e = new G).initialize(),
        ...
        }), u = C.trackingCallData.isStepAllowed("identify"), l = (d = window.navigator.userAgent,
        i = null !== (d = d.match(Z)),
        {
            hasItp: null !== d && 11 <= parseFloat(d[1]),
            isSafari: i
        }), w = u ? new Q(F,l,window,C) : new Y, b = new (u ? $ : X), d = new H(window), E = new ie(document,F), x = (r = d.retrieveConsent.bind(d),
        a = !1,
        c = void 0,
        s = [],
        function(e) {
            a ? e(c) : (s.push(e),
            1 === s.length && r(function(e) {
                a = !0,
                c = e;
        ...
        function S(e, t, n, o, i, r, a, c, s, u, l) {
            e.waitingForSyncframe && (e.waitingForSyncframe = !1,
            m(e, t, n, o, i, r, a, c, s, u, l))
        }
        function f(h, f, g, m, v, y, C, w, b, k, P, e) {
            h.shouldInjectSyncframe() && (e = h.createIframe(m, w.tagVersion, F, w.privateModeDetectionEnabled, e),
            window.addEventListener) && (F.addProtectedEventListener(window, "message", function(e) {
                ...
                l = k,
                d = P,
                ((p = (e = e).data) && e.origin == t.gumSyncFrameOrigin || window.BypassSyncframeMessageSanityCheck) && (e.stopPropagation(),
                i.checkCookies(p),
                t.waitingForSyncframe) && S(t, n, o, i, r, a, c, s, u, l, d)
            }, !0),
            O(f, k, b, {
                event: "appendtag",
                element: e
            ...
            if (200 < n.length)
                ...
                for (var i = 0, r = n; i < r.length; i++) {
                    ...
                    if (Object.keys)
                        ...
                        for (var s in a)
                            Object.prototype.hasOwnProperty.call(a, s) && (c += 1);
                    if (200 < c) {
                        o = !0;
                        break
                    }
        ...
        function m(e, t, n, o, i, r, a, c, s, u, l) {
            for (var d = [], p = t.queue, h = 0; h < p.length; ++h) {
                var f = p[h];
                if (f instanceof Array && p.splice.apply(p, [h + 1, 0].concat(f)),
                f instanceof Function)
                    p.splice(h + 1, 0, f());
                else if (f && "[object Object]" === f.toString())
                    switch (function(e, t, n, o, i, r, a, c, s, u, l, d, p, h) {
                        var f = l.event
                          , g = L(e, l);
                        if (null !== g)
                            return g;
                        ...
                        case "setparameter":
                            for (var m in l)
                                "event" !== m.toLowerCase() && l.hasOwnProperty(m) && (a.handlerParams[m] = l[m]);
                            return 1;
                        case "calldising":
                            M(a, e, l);
                            break;
                        ...
                        case "ceh":
                            l.event = "setemail",
                            l.hasOwnProperty("email") && (l.email instanceof Array || (l.email = [l.email]),
                            l.email = A(l.email));
                            var v = B(l);
                            return a.customerInfo.push(v),
                            J(e.actions, B(l)),
                            1;
                        case "setidentity":
                            if (l.hasOwnProperty("identity"))
                                if (0 < (v = A(v = l.identity instanceof Array ? l.identity : [l.identity])).length)
                                    return l.identity = v,
                                    e.actions.push(B(l)),
                                    1;
                            return 0;
                        case "setsitetype":
                            v = "d";
                            return "aios" !== l.type && "aa" != l.type || (v = l.type),
                        ...
                        case "flush":
                        case "flushevents":
                            return P(e, t, n, o, i, r, a, c, s, u, d !== p.length - 1 || 0 !== h.length),
                            1;
                        case "setaccount":
                            return a.account = l.account,
                            1;
                        case "seturl":
                            return a.handlerUrlPrefix = l.url,
                            1;
                        case "setcalltype":
                            return a.handlerResponseType = l.type,
                            1;
                        case "setresponsetype":
                            return a.responseType = l.type,
                            1;
                        case "setrequesttype":
                            return a.requestType = l.type,
                            1;
                        case "setpartnerpayload":
                            return a.partnerPayload = l.payload,
                            1;
                        case "oninitialized":
                            return c.onInitialized = l.callback,
                            1;
                        case "ondomready":
                            return c.onDOMReady = l.callback,
                            1;
                        case "beforeappend":
                            return c.beforeAppend = l.callback,
                            1;
                        case "aftereval":
                            return c.afterEval = l.callback,
                            1;
                        case "onflush":
                            return c.onFlush = l.callback,
                            1;
                        case "onurlgenerated":
                            return c.onUrlGenerated = l.callback,
                            1;
                        case "disonce":
                            return s.disOnce = !0,
                            1;
                        case "manualdising":
                            return s.manualDising = !0,
                            1;
                        case "manualflush":
                            return s.manualFlush = !0,
                            1;
                        case "nopartialflush":
                            return s.noPartialFlush = !0,
                            1;
                        case "disonpartialflush":
                            return s.partialDis = !0,
                            1
                        }
                        return e.actions.push(B(l)),
                        1
                    ...
                    case 0:
                        ...
                        break;
                    case -1:
                        d = d.concat(p.slice(h)),
                        h = p.length
                    }
            }
            s.afterEval instanceof Function && s.afterEval(),
            t.queue = d || [],
            u.manualFlush || u.noPartialFlush && 0 !== t.queue.length || e.waitingForSyncframe || P(t, n, o, i, r, a, c, s, u, l, 0 !== t.queue.length)
        }
        function M(e, t, n) {
            n.hasOwnProperty("account") || (n.account = t.accounts);
            e = e.handlerResponseType;
            n.hasOwnProperty("type") && (e = n.type,
            delete n.type),
            R(n.account, t.disingScheduled),
            "sequential" === e && (n.dc = !0)
        }
        function O(e, t, n, o) {
            var i = L(e, o);
        ...
        function k(e, t, n, o) {
            if (!e.bodyReady || t.container && document.body.contains(t.container) || (t.container = N.appendCriteoContainer(document.body)),
            o.url && (e = void 0,
            o.isImgUrl ? ((e = document.createElement("img")).setAttribute("style", "display:none;"),
            e.setAttribute("width", "1"),
            e.setAttribute("height", "1")) : ((e = document.createElement("script")).setAttribute("async", "true"),
            e.setAttribute("type", "text/javascript")),
            e.setAttribute("src", o.url),
            o.element = e),
            n.beforeAppend instanceof Function && (o.element = n.beforeAppend(o.element)),
            B(o),
        ...
        function L(e, t) {
            return !e.domReady && t.requiresDOM && "no" !== t.requiresDOM ? "blocking" === t.requiresDOM ? -1 : 0 : (delete t.requiresDOM,
            t.event ? (t.account && R(t.account, e.accounts),
            t.event = t.event.toLowerCase(),
            null) : (B(t),
            1))
        }
        function P(n, o, e, t, i, r, a, c, s, u, l) {
            if (c.onFlush instanceof Function && (c.onFlush(),
            W.warn("on flush hook is deprecated and will soon be removed. Please do not use it and contact criteo if you think this may break your integration")),
            0 !== n.actions.length) {
                ...
                for (var v, y, C, w = 0, b = n.actions; w < b.length; w++) {
                    var k = b[w];
                    (v = void 0) !== (k = k).identity && JSON.stringify && (v = k.identity instanceof Array ? k.identity : [k.identity],
                ...
                var _ = !1
                  , D = function(e, t, n, o, i, r, a, c) {
                    ...
                    void 0 !== e && (p = encodeURIComponent || escape,
                    u.push("csp-nonce=" + p(e)));
                    t.tryAppendUatParameter(u);
                    for (var l = 0; l < s.length; ++l) {
                        var d = s[l];
                        d.account && j(null === i.account ? void 0 : i.account, null === d.account ? void 0 : d.account) && delete d.account,
                        u.push("p" + l + "=" + U(o, r, a, d, []))
                    }
                    n.fillQueryStringParams(u, i),
                    null !== i.partnerPayload && u.push("pp=" + U(o, r, a, i.partnerPayload, []));
                    i.dynamic && u.push("dy=1");
                    ue(N.getHighestAccessibleUrl(window), u, i.fullUrlMaxLength, "fu", "ful"),
                    i.isStepAllowed("readPreviousUrl") && ue(N.getPreviousUrl(window), u, i.previousUrlMaxLength, "pu", "pul");
                ...
                function() {
                    ...
                    "function" == typeof c.onUrlGenerated ? c.onUrlGenerated(t.url) : "beacon" === a.requestType && navigator.sendBeacon ? navigator.sendBeacon(t.url) : O(n, s, c, t),
                ...
                x(function(e) {
                    var t, n;
                    D.push.apply(D, (t = [],
                    (n = (e = e).gdprConsent) && (void 0 !== n.gdprApplies && t.push("gra=" + (n.gdprApplies ? 1 : 0)),
                    void 0 !== n.consentData && t.push("grs=" + n.consentData),
                    void 0 !== n.version) && t.push("grv=" + n.version),
                    (n = e.ccpaConsent) && (void 0 !== n.uspString && t.push("cs=" + n.uspString),
                    void 0 !== n.version) && t.push("cv=" + n.version),
                    t)),
                    o.tryRunActionAfterAdBlockDetectionOrImmediate(A, function(e) {
        ...
        function U(e, t, n, o, i) {
            var r, a, c, s, u, l = encodeURIComponent || escape, d = "";
            if (o instanceof Function)
                ...
                var f, g, m = [];
                for (f in o)
                    o.hasOwnProperty(f) && (g = i.concat([f]),
                    m.push((c = e,
                    s = f,
                    u = (u = g).join("."),
                    (c.properties[u] || s) + "=" + U(e, t, n, o[f], g))));
                d += m.join("&")
        ...
        return F.catchAndStoreException(function() {
            ...
            r = C.encodingConfig,
            a = C.parsingConfig,
            c = C.trackingCallData,
            s = C.hooks,
            u = C.workflow,
            l = C.identifierScrappingConfig,
            e.setWaitingFlag(o),
            e.waitingForSyncframe && F.setProtectedTimeout(function() {
                S(e, t, n, o, i, r, a, c, s, u, l)
            }, 1e4),
            N.onBodyReady(F, function() {
                C.hooks.onInitialized instanceof Function ? (y.app.bodyReady = C.hooks.onInitialized(),
                W.warn("onInitialized hook is deprecated and will soon be removed. Please do not use it and contact criteo if you think this may break your integration")) : y.app.bodyReady = !0,
                x(function(e) {
            ...
            N.onDocumentReady(F, function() {
                C.hooks.onDOMReady instanceof Function ? (y.app.domReady = C.hooks.onDOMReady(),
                W.warn("on DOM ready hook is deprecated and will soon be removed. Please do not use it and contact criteo if you think this may break your integration")) : y.app.domReady = !0,
                m(b, y.app, y.cbs, w, C.shortNameMap, C.encodingConfig, C.parsingConfig, C.trackingCallData, C.hooks, C.workflow, C.identifierScrappingConfig)
            });
            ...
            return v("visitEventEnabled", !1) && oe(g, y.app),
            ne({
    ...
    function ue(e, t, n, o, i) {
        var r;
        e && 0 !== (e = e.trim()).length && (n < (e = (r = encodeURIComponent || escape)(e)).length && (t.push(i + "=" + e.length),
        e = e.substr(0, n)),
        i = r(e),
        t.push(o + "=" + i))
    }
    (!window.criteo_q || window.criteo_q instanceof Array) && (P = window.criteo_q || [],
    window.criteo_q = se(),
    P.adBlockDetector,

...
/***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DEFAULT_COOKIE_TTL = 90; // Days.
            ...
            class Store {
                constructor(dbName = 'npm', storeName = 'keypart') {
            ...
            function idb_keyval_close(store = getDefaultStore()) {
                store._closeIDBStore();
            }
            ...
            var DEFAULT_DATABASE_NAME = 'npm';
            var DEFAULT_STORE_NAME = 'keypart';
                            ...
                            return regeneratorRuntime.wrap(function _callee2$(_context2) {
                                while (1) {
                                    switch (_context2.prev = _context2.next) {
                                        case 0:
                                            _context2.next = 2;
                                            var vget = idb_keyval_get(key, this.store);
                                            idb_keyval_close(this.store);
                                            return vget;
                                        case 2:
                            ...
                            return regeneratorRuntime.wrap(function _callee3$(_context3) {
                                while (1) {
                                    switch (_context3.prev = _context3.next) {
                                        case 0:
                                            _context3.next = 2;
                                            var vset = idb_keyval_set(key, value, this.store);
                                            idb_keyval_close(this.store);
                                            return vset;
                                        case 2:
                                        case "end":
                                        ...
                                        case 6:
                                            ...
                                            if (!(value !== undefined)) {
                                                ...
                                                if (firstValue !== undefined && secondValue === undefined) {
                                                    ...
                                                    value = firstValue;
                                                    return _context4.abrupt("return", firstValue);
                                                }
                                                else if (firstValue === undefined && secondValue !== undefined) {
                                                    _context4.next = 21;
                                                    this.set(key, secondValue);
                                                    value = secondValue;
                                                    return _context4.abrupt("return", secondValue);
                                                }
                                                else { _context4.next = 18; }
                                                //end special code
                                                break;
                                            }
                                            _context4.next = 15;

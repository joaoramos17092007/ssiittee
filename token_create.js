...
, function(n, e) {
    function t(n, e) {
        return function(n) {
            ...
            if (null != t) {
                var r, i, c = [], a = !0, o = !1;
                try {
                    for (t = t.call(n); !(a = (r = t.next()).done) && (c.push(r.value),
                    !e || c.length !== e); a = !0)
                        ;
                } catch (n) {
                    o = !0,
    ...
    for (var c = 0, a = Object.entries(i.LIST); c < a.length; c++) {
        var o = t(a[c], 2)
          , u = o[0]
          , o = o[1];
        "true" === new URLSearchParams(window.location.search).get(o.uri) && (i.LIST[u].chance = 100)
    }
